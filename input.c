...
void get_alias(char alias[101], FILE* fp){
...
void en_game_score(char alias[101], int* ScorePlayer,FILE* fp, int* updateScore, int* nbline, char alias[101]){
...
int main(){
	...
	end_game(name,&score,file, &updateScore, &nbline);
